...
def upgrade() -> None:
    ...
    # 1. Создание таблицы промо-слайдера (безопасно)
    ...
    if 'slug' not in columns:
        op.add_column('characters', sa.Column('slug', sa.String(length=100), nullable=True))
    
    # 3. Безопасная работа с индексом
    indexes = [idx['name'] for idx in inspector.get_indexes('characters')]
    if 'ix_characters_slug' in indexes:
