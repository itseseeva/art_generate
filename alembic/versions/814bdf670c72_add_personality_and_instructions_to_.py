...
def upgrade() -> None:
    ...
    # Cleanup Django/Token tables (ignore failures if already gone)
    django_cleanup = [
        ('drop_index', 'token_blacklist_outstandingtoken_jti_hex_d9bdf6f7_like', 'token_blacklist_outstandingtoken'),
        ('drop_index', 'token_blacklist_outstandingtoken_user_id_83bc629a', 'token_blacklist_outstandingtoken'),
        ('drop_table', 'token_blacklist_outstandingtoken', None),
        ('drop_index', 'django_session_expire_date_a5c62663', 'django_session'),
        ('drop_index', 'django_session_session_key_c0390e0f_like', 'django_session'),
        ('drop_table', 'django_session', None),
        ('drop_table', 'django_content_type', None),
        ('drop_table', 'django_migrations', None),
        ('drop_index', 'auth_group_permissions_group_id_b120cbf9', 'auth_group_permissions'),
        ('drop_index', 'auth_group_permissions_permission_id_84c5c92e', 'auth_group_permissions'),
        ('drop_table', 'auth_group_permissions', None),
        ('drop_index', 'auth_group_name_a6ea08ec_like', 'auth_group'),
        ('drop_table', 'auth_group', None),
        ('drop_index', 'django_admin_log_content_type_id_c4bce8eb', 'django_admin_log'),
        ('drop_index', 'django_admin_log_user_id_c564eba6', 'django_admin_log'),
        ('drop_table', 'django_admin_log', None),
        ('drop_index', 'auth_permission_content_type_id_2f476e4b', 'auth_permission'),
        ('drop_table', 'auth_permission', None),
        ('drop_table', 'token_blacklist_blacklistedtoken', None),
    ]

    for op_type, name, table in django_cleanup:
        try:
    ...
    try:
        op.drop_constraint(op.f('uq_character_available_tags_name'), 'character_available_tags', type_='unique')
    except Exception:
        pass
    ...
    try:
        op.drop_index(op.f('idx_users_country'), table_name='users')
    except Exception:
        pass
