...
Revision ID: 7c1c4c8a9be0
Revises: 97e10a42e728
Create Date: 2026-01-04 14:28:21.154089
...
revision: str = '7c1c4c8a9be0'
down_revision: Union[str, Sequence[str], None] = '97e10a42e728'
...
def upgrade() -> None:
    ...
    # Остальные Django таблицы
    for table_name in ['django_content_type', 'django_migrations', 'token_blacklist_blacklistedtoken']:
        if table_name in inspector.get_table_names():
            op.execute(text(f'DROP TABLE IF EXISTS {table_name}'))
