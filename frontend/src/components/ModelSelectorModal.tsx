...
const AVAILABLE_MODELS = [
  ...
  },
  {
    ...
    name: 'MythoMax 13B',
    subtitle: '«Быстрая и эффективная модель для диалогов»',
    features: 'Легкая и быстрая модель с хорошим балансом качества и скорости ответа.',
    style: 'Пишет естественно и живо, хорошо поддерживает характер персонажа.',
    forWho: 'Хороший выбор для быстрых ответов без потери качества диалога.'
  }
];
