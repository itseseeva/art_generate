...
export const Footer: React.FC = () => {
  return (
    <FooterContainer>
      ...
      <SeoContainer>
        <SeoText>
          Candy Girls Chat — это современный чат бот с ИИ, где доступны ии чаты с девушками 18 и аниме персонажами на русском языке. Мы предлагаем бесплатный чат с ии без ограничений, чтобы вы могли наслаждаться ролевыми играми с виртуальными персонажами с фото в любое время.
        </SeoText>
      </SeoContainer>
    </FooterContainer>
  );
