...
TAG_NAME = "Аниме"
TAG_DESCRIPTION = "Твои любимые герои аниме оживают в Candy Girls Chat Погрузись в миры популярных тайтлов, общайся с вайфу и кунами на русском языке без цензуры. ИИ чат с персонажами аниме 18+ — это возможность переписать сюжет или создать свою уникальную историю в стиле японской анимации бесплатно."
